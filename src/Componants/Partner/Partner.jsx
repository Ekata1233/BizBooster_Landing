...
function Partner() {
    ...
    return (
        <div className="bg-white text-dark w-100 py-4">
            ...
            <h2 className="fw-bold text-center" style={{ background: 'linear-gradient(135deg, #1e3c72, #2a5298)', WebkitBackgroundClip: 'text', color: 'transparent' }}>Our Esteemed Business Partners</h2>
